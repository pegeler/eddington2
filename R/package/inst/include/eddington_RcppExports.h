...
namespace eddington {
    ...
    inline int E_num(IntegerVector& rides) {
        typedef SEXP(*Ptr_E_num)(SEXP);
        static Ptr_E_num p_E_num = NULL;
        if (p_E_num == NULL) {
            validateSignature("int(*E_num)(IntegerVector&)");
    ...
    inline IntegerVector E_cum(IntegerVector& rides) {
        typedef SEXP(*Ptr_E_cum)(SEXP);
        static Ptr_E_cum p_E_cum = NULL;
        if (p_E_cum == NULL) {
            validateSignature("IntegerVector(*E_cum)(IntegerVector&)");
    ...
    inline List E_next(IntegerVector& rides) {
        typedef SEXP(*Ptr_E_next)(SEXP);
        static Ptr_E_next p_E_next = NULL;
        if (p_E_next == NULL) {
            validateSignature("List(*E_next)(IntegerVector&)");
